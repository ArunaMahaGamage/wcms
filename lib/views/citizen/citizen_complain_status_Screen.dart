...
class CitizenComplainStatusScreen extends ConsumerWidget {
  const CitizenComplainStatusScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    switch (status) {
      case CitizenComplainStatus.idle:
        content = Text("Please start", style: TextStyle(fontSize: 18));
        break;
      case CitizenComplainStatus.loading:
        content = Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text("waiting...", style: TextStyle(fontSize: 18)),
          ],
        );
        break;
      case CitizenComplainStatus.success:
        content = Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text("Complain Successful!", style: TextStyle(fontSize: 18)),
          ],
        );
        break;
      case CitizenComplainStatus.error:
        content = Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text("Complain Failed. Try again.", style: TextStyle(fontSize: 18)),
          ],
        );
        break;
    }

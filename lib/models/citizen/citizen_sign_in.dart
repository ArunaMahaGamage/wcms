...
factory CitizenSignIn.fromMap(Map<String, dynamic> map) { return CitizenSignIn( id: map['id'] is int ? map['id'] : int.tryParse(map['id'].toString()), idNumber: map['idNumber'] ?? '', userID: map['userID'] ?? '', password: map['password'] ?? '',

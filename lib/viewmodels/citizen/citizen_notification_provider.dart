...
import 'package:wcms/api/citizen/notification_api_service.dart';
...
final collectionNotificationProvider = FutureProvider<List<CitizenCollectionNotification>>((ref) async {
  ...
  final citizenId = citizenSignInStore?.idNumber ?? '';

  if (citizenId.isEmpty) return [];

  return await NotificationApiService().fetchNotifications(citizenId);
});